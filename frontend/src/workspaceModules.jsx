...
export const workspaceModules = [
  ...
  {
    id: 'admin-students',
    path: '/workspace/admin/students',
    title: '用户管理',
    eyebrow: 'STUDENTS',
    description: '按学生查看学校提交状态，并为学生刷新状态或发起实验提交。',
    icon: <TeamOutlined />,
    roles: ['admin'],
    status: '总览',
  },
  ...
  {
    id: 'admin-playwright-sessions',
    path: '/workspace/admin/playwright-sessions',
    title: '自动化任务',
    eyebrow: 'AUTOMATION',
    description: '查看学校系统自动化任务和 Playwright 浏览器会话，支持终止任务与释放会话。',
