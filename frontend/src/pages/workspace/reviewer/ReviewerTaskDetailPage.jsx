...
export default function ReviewerTaskDetailPage() {
  ...
  const initialFormValues = Object.keys(submission?.corrected_json || {}).length > 0 
    ? submission.corrected_json 
    : (Object.keys(submission?.recognition_json || {}).length > 0 ? submission.recognition_json : null);
