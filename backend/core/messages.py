...
AUTOMATION_MESSAGES: Dict[str, str] = {
    ...
    "school.overview.connecting": "正在连接学校系统...",
    "school.overview.openingLogin": "正在打开学校系统登录页...",
    "school.overview.recognizingCaptcha": "正在识别登录验证码...",
    "school.overview.loggingIn": "正在登录学校系统...",
    ...
    "school.detail.connecting": "正在连接学校系统...",
    ...
    "school.submit.connecting": "正在连接学校系统...",
    ...
    "school.submit.returningList": "正在返回完成报告列表...",
    "school.submit.readingStatus": "正在读取学校系统提交状态...",
